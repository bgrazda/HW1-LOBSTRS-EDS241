...
spiny_counts %>%
    tbl_summary(by = site, statistic = list(all_continuous() ~ "{mean}")) |> 
    modify_header(label ~ "**Variable**") %>%
    modify_spanning_header(c("stat_1") ~ "**Treatment**")
...
The concept of dispersion of this model
